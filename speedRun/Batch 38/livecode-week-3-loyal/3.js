...
function nilaiKuliah(nama, matkul1, matkul2, matkul3) {
  ...
  let grade = ""
  let totalNilai = (matkul1+matkul2+matkul3)/3
  if (totalNilai>=80){
    grade = 'A'
    let juara = ' kamu adalah lulusan pertama terbaik'
    return 'Selamat '+nama+' grade kamu adalah '+grade+', '+juara
  } else if ( totalNilai >=70 && totalNilai<80){
    grade = 'B'
    let juara = ' kamu adalah lulusan kedua terbaik'
    return 'Selamat '+nama+' grade kamu adalah '+grade+', '+juara
  } else if ( totalNilai <70){
    grade = 'C'
    let juara = "kamu lulus"
    return 'Selamat '+nama+' grade kamu adalah '+grade+', '+juara
  }
}
